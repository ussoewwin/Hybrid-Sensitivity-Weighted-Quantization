"""
Quantize SDXL model to FP8 (HSWQ V1.2: SageAttention2 Accelerated Calibration).
...
- HSWQ V1.2: SageAttention2-accelerated calibration option (--sa2)

Algorithm: same as V1.1.
"""
