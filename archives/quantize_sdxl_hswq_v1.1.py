"""
SDXL FP8 quantization script (HSWQ V1.1: Standard Compatible Mode).
HSWQ spec: Sensitivity protection and Importance-weighted MSE. No scaling (scaled=False).
V1.1: DualMonitor 2D input support (time_embedding etc. (B, C) shape).

Changelog: V13 Dual Monitor; V15 weighted histogram MSE; HSWQ V1 scaled=False; V1.1 2D input.

Algorithm: Calibration (Sensitivity + Importance; V1.1 supports 4D/3D/2D). Layer selection (top N% FP16 keep). Quantization: others -> weighted histogram, amax with scaled=False, clip and cast.
"""
...
# --- ComfyUI-compatible mapping functions ---
