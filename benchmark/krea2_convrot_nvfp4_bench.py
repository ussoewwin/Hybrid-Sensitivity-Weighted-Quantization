...
NVFP4 runtime MUST import only from benchmark/krea2_convrot_nvfp4.
Never import benchmark/nvfp4.

Example:
  python krea2_convrot_nvfp4_bench.py \\
...
def main() -> int:
    ...
    # Ensure benchmark/ is on path for krea2_convrot_nvfp4 + int8 packages
