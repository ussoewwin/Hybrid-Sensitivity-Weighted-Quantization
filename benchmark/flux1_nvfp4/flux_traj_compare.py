...
BENCH = os.path.join(_BENCH_DIR, "flux_int8_bench.py")
_spec = importlib.util.spec_from_file_location("flux_bench", BENCH)
...
def main() -> int:
    ...
    try:
        ...
        q = bench._load_diffusion_model(args.fp8)
        q_runs = {}
        for s in seeds:
