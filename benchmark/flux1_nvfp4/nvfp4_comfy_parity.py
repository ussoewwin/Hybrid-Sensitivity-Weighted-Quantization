"""
Flux1 NVFP4 bench — force ComfyUI MixedPrecision path (ops.py) verbatim.

Package-local under benchmark/flux1_nvfp4/ only. Never import benchmark/nvfp4/.
...
def apply_nvfp4_comfy_parity() -> bool:
    """Runtime only. Imports stay inside flux1_nvfp4 (never benchmark/nvfp4/)."""
    global _APPLIED
    import logging
