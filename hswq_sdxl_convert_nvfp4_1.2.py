...
def run_nvfp4_calib(
    *,
    ...
    → grayzone → _apply_fp16_budget_cap (hard ceiling 600 MiB).
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "--fp16_budget_mb (600 MiB hard ceiling). Top-%% cut is forbidden."
        ),
    )
    parser.add_argument(
        "--fp16_budget_mb",
        ...
        default=600.0,
        help=(
            "Owner hard ceiling: must be exactly 600 MiB FP16 overhead vs "
