...
HSWQ spec-compliant weighted histogram MSE optimization module.
...
This module provides:
    1. WeightedHistogram: build histogram weighted by input importance
    2. FP8E4M3Quantizer: accurate FP8 E4M3 quantize/dequantize simulation
    3. MSEOptimizer: amax search via full MSE optimization
"""
...
class FP8E4M3Quantizer:
    ...
    # All representable positive FP8 E4M3 values (incl. denormals)
