...
- **Text Encoder & ControlNet (native ConvRot INT8):** [How to quantize Text Encoder and ControlNet](md/How%20to%20quantize%20Text%20Encoder%20and%20ControlNet.md) — ComfyUI custom node (`TE / ControlNet ConvRot INT8 Quantize`) in-graph quantization guide for Text Encoders (CLIP-L, CLIP-G, T5-XXL, Qwen2.5-VL) and ControlNet / ControlNet Union models (SDXL, Illustrious-XL, Qwen-Image, FLUX.1-dev).
