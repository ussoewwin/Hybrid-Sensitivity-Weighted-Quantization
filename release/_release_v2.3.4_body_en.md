...
5. **Native ConvRot INT8 Recommendation**: For checkpoints where native ConvRot INT8 achieves mean latent trajectory cosine $\ge 0.98$ (with 0 trajectory bifurcations), **using native ConvRot INT8 directly without HSWQ is recommended**, providing maximum VRAM savings and inference speedup with zero perceptible degradation.
...
## Model Footprint & Memory Reduction
