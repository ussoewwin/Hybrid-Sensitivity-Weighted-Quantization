...
| Official FP8 floor | V7 Official FP8 SSIM **0.8731** ([`test/benchmark_zit.md`](../test/benchmark_zit.md)) |
...
From [`test/benchmark_zit.md`](../test/benchmark_zit.md) (source: `test/score_zi.txt`):
...
**Source:** Console `ZIT FP8 BENCHMARK RESULTS` output pasted during v1.93 cloud runs (session transcript `98a4cd24-805b-484d-adef-7f57bf51f40b`). **Not** in [`test/benchmark_zit.md`](../test/benchmark_zit.md) or `test/score_zi.txt` — cite as interim cloud measurements only.
...
- [Z Image benchmark table](../test/benchmark_zit.md) — moody V6/V7 rows  
