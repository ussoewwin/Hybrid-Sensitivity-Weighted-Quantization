...
`scikit-image` is required for SSIM in `benchmark/nvfp4bench_sdxl.py` (post-quantize bench and standalone re-runs). `comfy_kitchen` provides the quantization kernels and NVFP4/INT8 layout operations.
