...
- **[HSWQ INT8 (SDXL V3.0) — Technical Overview](HSWQ_INT8_SDXL_Technical_Guide.md)** — INT8 guide (SDXL primary; Z Image V1.0 shares absmax pack / V4 FP16 ranking / r0 / `int8_tensorwise`): SDXL **300 MiB** (`quantize_sdxl_hswq_v3.0.py`); Z Image **700 MiB** (`quantize_zi_int8_hswq_v1.0.py`).
