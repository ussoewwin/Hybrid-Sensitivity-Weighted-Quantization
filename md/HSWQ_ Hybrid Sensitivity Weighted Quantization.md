...
1.  **Sensitivity Monitor (output variance)**:
    ...
    *   **Action**: Layers that hurt image quality most if corrupted → top 5–25% kept in FP16 (for SDXL and ZIT, 5–10% often gives sufficient quality).
...
*   **Keep Ratio**: typically `0.05`–`0.25` (5–25%)
    *   Safety margin to protect critical layers; for SDXL and ZIT, 5–10% often gives sufficient quality.
*   **Steps**: `20–25`
