"""
HSWQ V3.1 SDXL INT8 Quantization Script
========================================
...
# 25-seed deterministic trajectory comparator for post-quantize INT8 validation (widely dispersed)
...
def main():
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "--fp16=--input --int8=--output across 25 deterministic trajectory seeds. "
    ...
    if args.convrot:
        ...
        rotate_weight = _nc.rotate_weight
    ...
    if not torch.cuda.is_available():
        print("[FATAL] CUDA is required for quantize_sdxl_hswq_v3.1.py.")
