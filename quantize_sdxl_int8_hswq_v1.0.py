"""
HSWQ V1.0 SDXL INT8 Quantization Script (standalone)
====================================================
Hybrid Sensitivity Weighted Quantization for Stable Diffusion XL (UNet only),
INT8 (symmetric per-tensor) edition.

Standalone entrypoint: DualMonitor, UNet load, and the +300 MiB FP16 budget
engine live in THIS file. Does NOT import quantize_sdxl_hswq_v3.0.py.
External packages allowed: analyze/ and histogram/ only.

INT8-specific engine (same capability set as the former V3.0 body):
...
def main():
    parser = argparse.ArgumentParser(description="SDXL INT8 Quantization - HSWQ V1.0 (standalone Autonomous Engine, INT8 per-tensor)")
    ...
    print("=" * 60)
    print("HSWQ V1.0 SDXL INT8 Pure Autonomous Engine (standalone; Environment-Aware Analysis)")
    print("=" * 60)
