...
HSWQ DualMonitor + FP16 protect, when --calib_file is set (r0 only):
  ...
  - --keep_ratio must be 0. FP16 set = comprehensive judgment only:
    ...
    (hard ceiling 700 MiB). No top-% cut. No fixed recipe.
...
def _apply_fp16_budget_cap(
    ...
    *,
    ...
    Owner hard ceiling is installed by the caller (NVFP4 700 via
...
def run_nvfp4_calib(
    *,
    ...
    → grayzone → _apply_fp16_budget_cap (hard ceiling 700 MiB).
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description=(
            ...
            "HSWQ DualMonitor r0 FP16 protect (--fp16_budget_mb=700 hard "
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "(amax/(F8_E4M3_MAX*F4_E2M1_MAX); NVFP4 Linear packs unrotated, "
            "so amax is measured on unrotated activations). "
            "Also enables HSWQ DualMonitor r0 FP16 protect "
            "(--fp16_budget_mb hard ceiling) + NVFP4/INT8 pack-roundtrip "
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "--fp16_budget_mb (700 MiB hard ceiling). Top-%% cut is forbidden."
        ),
    )
    parser.add_argument(
        "--fp16_budget_mb",
        ...
        default=700.0,
        help=(
            "Owner hard ceiling: must be exactly 700 MiB FP16 overhead vs "
